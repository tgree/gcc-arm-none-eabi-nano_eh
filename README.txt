...
gnu-devtools-for-arm repo.  This one is similar to the clause that builds the
...
exception tables.  See the github repo here for details:
https://github.com/tgree/gnu-devtools-for-arm-nano_eh.git
...
cd docker
docker build -t gcc-arm-none-eabi-13.3.rel1-nano_eh-build .
docker run -ti gcc-arm-none-eabi-13.3.rel1-nano_eh-build
...
sudo tar x -C /usr \
    -f gcc-arm-none-eabi-13.3.rel1-nano-eh-x86_64-linux.tar.xz
